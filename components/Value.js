  ...
  <section className="text-gray-700 body-font">
    <div className="container px-5 py-2 mx-auto">
      <div className="text-center mb-8">
        ...
        <p className="text-xl leading-relaxed xl:w-2/4 lg:w-3/4 mx-auto text-gray-600">
      ...
      <div className="flex flex-wrap">
        <div className="p-4 md:w-1/3 flex flex-col text-center items-center">
          <div className="w-20 h-20 inline-flex items-center justify-center rounded-full bg-blue-100 text-blue-500 mb-5 flex-shrink-0 text-3xl">
            🚀
          </div>
          <div className="flex-grow">
            <h2 className="text-gray-900 text-xl title-font font-bold tracking-tight mb-3">
              Builder's mindset
            </h2>
